...
import { RedButton } from "./CustomButton";
...
// Heading 6
export const Heading6: React.FC<HeadingProps> = ({
  text = "",
  color,
  align,
}) => {
...
export const SubHeading2: React.FC<HeadingProps> = ({ text = "", color }) => {
  ...
  return (
    <div className="uppercase text-[11px] font-bold text-[#374151] text-center flex justify-center items-center flex-none">
      {text}
    </div>
  );
};

export const SubHeadingSpan: React.FC<HeadingProps> = ({
  text = "",
  color,
}) => {
  // const textColor = color ? color : '';
  ...
  return (
    <span className="uppercase text-[11px] font-bold text-[#374151] text-center">
      {text}
    </span>
  );
};

export const SubHeadingSpan1: React.FC<HeadingProps> = ({
  textNum = 6,
  color,
}) => {
  // const textColor = color ? color : '';
...
export const UpdateContentBox = (props: { children: ReactNode }) => {
  return <div className="w-full grid grid-cols-5">{props.children}</div>;
};
...
export const CardDiv = (props: { children: ReactNode }) => {
  ...
  return (
    <div className="grid grid-cols-2 text-justify shadow shadow-slate-500 w-80 p-3">
      {props.children}
    </div>
  );
};

export const SpanHeading = (props : {children: ReactNode,  onClick: any}) => {
  return (
    <span
      className="text-red-600 cursor-pointer px-10 font-bold text-center"
