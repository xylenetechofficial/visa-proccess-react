        ...
        <Box sx={style}>
          ...
          <div className="grid grid-cols-1 py-2  gap-2 shadow">
            ...
            <div className="grid grid-cols-2 px-2">
              ...
              <button
                type="button"
                className="text-white bg-[#FF5252] hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-[5px] text-sm px-28 py-2.5 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" onClick={onClose}
              >
                {cancelButtonName}
              </button>
