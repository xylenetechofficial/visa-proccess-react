...
export function NavbarResponsiveFeatures(props: {
  searchFunction: (ele: string) => void;
  refresh?: () => void;
}) {
  // ! becarefull
  ...
  return (
    <ul className="flex flex-wrap justify-between p-4 mt-4 font-medium border rounded-lg md:justify-normal md:items-center md:p-0 md:flex-row-reverse md:space-x-8 md:mt-0 md:border-0 ">
      ...
      <li
        className="mb-3 cursor-pointer md:mb-0 md:ml-3"
        onClick={() => {
      ...
      >
        ...
        <div
          ...
          className={
            showHideClass
              ? "z-10 show bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 class-2"
        ...
        <div className="">
          ...
          <div className="relative flex">
            ...
            <input
              type="search"
              id="default-search"
              className="w-full p-3 pl-10 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-gray-700 focus:border-gray-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Search..."
              required
            ...
            <button
              type="button"
              className="text-white bg-[#2196F3] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2"
            >
              Search
            </button>
          </div>
    ...
    <>
      <nav className="border-gray-200 bg-main-bg dark:bg-gray-900">
        <div className="flex flex-wrap items-center justify-between p-4 mx-auto max-w-screen-2xl">
          ...
          <div
            className="hidden w-full mx-4 grow md:block md:w-auto"
            id="navbar-default"
          >
...
export function CustomNavbarV2() {
  return (
    <nav className="fixed top-0 z-50 w-full border-b border-gray-200 bg-main-bg dark:bg-gray-800 dark:border-gray-700">
...
export function CustomNavbarV3(props: {
  pageName: string;
  searchFunction: (ele: string) => void;
  refresh?: () => void;
}) {
  return (
    <nav className="mb-3 -mx-2 shadow-navbar md:-mx-6 bg-main-bg dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex flex-wrap items-center justify-between mx-auto ">
          <div className="flex items-center justify-start">
            ...
            <a href="" className="flex items-center ml-2 md:mr-24">
              ...
              <span className="self-center text-[28px] font-semibold whitespace-nowrap text-primary-text">
                {props.pageName}
              </span>
            </a>
          </div>
...
export function MainContent(props: { children: any }) {
  return (
    <div id="MainContent" className="px-2 md:px-6 sm:ml-64">
      <div className="">
        <ToastContainer
          position="top-center"
          autoClose={3000}
...
export function NotificationView(props: {
  ...
  return (
    <div
      className="custom-className-scrollbar w-80 h-20 overflow-auto px-5 py-2 border-2 border-[#46CEFF] rounded-lg"
...
function QuickNotification(props: { notification: NotificationInterface }) {
  return (
    <div
      className="flex p-1 mb-1 text-xs text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
      role="alert"
    >
      <svg
        aria-hidden="true"
      ...
      <div>
        <span className="font-medium">
          {props.notification.category} alert!
        </span>{" "}
        ...
        {props.option.map((option: any) => (
          <FormControlLabel
            ...
            control={
              <Checkbox
                checked={
                  props.value && props.value.includes(option.value.toString())
                }
                onChange={(event) => {
                  const value = event.target.value;
                  console.log(value);
