...
export default function Main(props: {
  ...
  const [clientAdditionalInvoice, setclientAdditionalInvoice] = useState(
    props?.clientAdditionalInvoiceList
  );

  async function onClickAdd() {
    const flag = await updateClientAdditionalInvoice(
      clientAdditionalInvoice?.id,
      clientAdditionalInvoice
    );
    if (flag) {
      props.onClose();
