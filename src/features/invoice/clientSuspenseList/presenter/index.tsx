...
export default function Main() {
  ...
  const [clientSuspence, setClientSuspence] = useState<
    ClientSuspenseInterface[]
  >([]);
  ...
  return (
    <div className="h-screen">
      ...
      <CardHeader>
        {
          ...
          <RedButton
            text="Add Client Suspence Amount"
      ...
      {modal === "edit" ? (
        <ClientSuspenceEdit
          onClose={() => {
            fetchClientAdditionalInvoiceList(), setModal("");
          }}
          clientSuspence={clientSuspence}
          fetchClientAdditionalInvoiceList={fetchClientAdditionalInvoiceList}
          createClientAdditionalInvoiceTemp={createClientAdditionalInvoiceTemp}
