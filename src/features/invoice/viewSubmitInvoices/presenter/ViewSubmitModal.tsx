...
import { FileInput, UnlabeledInput } from "../../../../componenets/Input";
...
export default function Main(props: {
    ...
    const initial: any = {
        ...
        submit_remarks: props.submittedInvoice.remarks ? props.submittedInvoice.remarks : '',
            ...
            <Box sx={style}>
                ...
                <div className="grid grid-cols-1 py-3  gap-2 shadow">
                    ...
                    <UpdateContentBox>
                        ...
                        <FileInput handleFileChange={(file) => setInvoiceDta({ ...invoiceData, submit_file: file })} />

                    </UpdateContentBox>

                    <div className="flex justify-center">
                        <GreenButton text="submit" onClick={() => onClickCreate(props.submittedInvoice.id, invoiceData)} />
