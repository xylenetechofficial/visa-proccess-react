            ...
            <TableRow3 key={index + 1}>
              ...
              <TableCell3>
                <UnlabeledInput
                  value={ele.remarks}
                  onchange={(value) => {
                    onUpdateRow(index, { ...ele, remarks: value });
                  }}
                />
              </TableCell3>
