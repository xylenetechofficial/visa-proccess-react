...
export default function Main(props: {
  ...
  const [selectionListEle, setSelectionListEle] =
    useState<SelectionInterface>(initValue);
    ...
    >
      <div className=" grid grid-cols-1 py-3  gap-2 shadow">
        <UpdateContentBox>
          ...
          <CustomSelectComponentUnlabeled
            onChange={(value) =>
              setSelectionListEle({ ...selectionListEle, company_id: value })
            }
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, name: value })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, passport_no: value })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, ha: parseInt(value) })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, ta: parseInt(value) })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, fa: parseInt(value) })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({
                ...selectionListEle,
                other_allowance: parseInt(value),
              })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <CustomSelectComponentUnlabeled
            ...
            onChange={(value: any) =>
              setSelectionListEle({ ...selectionListEle, agent: value })
            }
            options={selectOptionConveter({
              options: agentList,
              options_struct: { name: "name", value: "id" },
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, age: parseInt(value) })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <CustomSelectComponentUnlabeled
            ...
            onChange={(value) =>
              setSelectionListEle({ ...selectionListEle, sector: value })
            }
            options={selectOptionConveter({
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, contact_no: value })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <DateInput
            ...
            onChange={(value) =>
              setSelectionListEle({ ...selectionListEle, date_of_birth: value })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, address: value })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, nominee_name: value })
            }
          />
        </UpdateContentBox>
        <UpdateContentBox>
        ...
        <UpdateContentBox>
          ...
          <CustomSelectComponentUnlabeled
            ...
            onChange={(value) =>
              setSelectionListEle({ ...selectionListEle, religion: value })
            }
        ...
        <UpdateContentBox>
          ...
          <UnlabeledInput
            ...
            onchange={(value) =>
              setSelectionListEle({ ...selectionListEle, division: value })
            }
          />
        </UpdateContentBox>
      </div>
