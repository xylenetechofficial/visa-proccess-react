        ...
        <Box sx={style}>
            ...
            <div className="grid grid-cols-1 py-3  gap-2 shadow justify-center">
                ...
                <UpdateContentBox>
                    ...
                    <CustomSelectComponentUnlabeled options={[]} onChange={(value)=>console.log(value)}/>
                </UpdateContentBox>


                <UpdateContentBox>
                    <SubHeading1 text="AMOUNT   :" />
                    <UnlabeledInput placeholder="amount" value={''} onchange={(value)=>setData({...data , amount:value})}/>
                </UpdateContentBox>

                <UpdateContentBox>
                    <SubHeading1 text="DESCRIPTION OF PAYMENT  :" />
                    <TextAreaInput id="description" onChange={(value)=>console.log(value)}/>
                </UpdateContentBox>
