...
const VisaProfessionTable = (props: {
    ...
    const onClickRemoveRow = (index: number) => {
        if (!confirm("Are You Sure?"))
            return
        const arr = props.visaProfessionList.filter((e:any, i:any) => i !== index)
        props.onChange(arr)
    ...
    function onUpdateRow(index: number, rowData: any) {
        const nextData = props.visaProfessionList.map((e:any, i:any) => {
            if (i === index) {
    ...
    return (
        <div className='overflow-auto' style={{ justifyContent: "center" }}>
            ...
            <Table  >
                ...
                <TableBody>
                    {props.visaProfessionList && props.visaProfessionList.map((ele:any, index:any) => (
                        <TableData
                            data={ele}
                            index={index}
                            onChange={onChange}
