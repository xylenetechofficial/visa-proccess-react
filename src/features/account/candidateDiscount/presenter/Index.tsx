...
export default function Main() {
  ...
  const [CandidateDiscountList, setCandidateDiscountList] = useState<
  ...
  return (
    <div>
      ...
      <CardHeader>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3 mb-4 justify-center flex-end">
          <UpdateContentBox>
            ...
            <TextAreaInput
              id="discount"
              value={discountAndRemark.discount}
              onChange={(value) => {
          ...
          <UpdateContentBox>
            ...
            <TextAreaInput
              ...
              onChange={(value) =>
                setDiscountAndRemark((prev) => {
                  return { ...prev, discount_remark: value };
                })
              }
            />
          </UpdateContentBox>
      ...
      {authPermissionList.url_has("create") ? (
         ...
         buttonText="Submit"
         onClick={() => {
           handleSubmit(CandidateDiscountList);
         }}
       />
        ) : (
          ""
        ...
        {modalName === "Edit" ? (
          <EditCandidateDiscountTable onClose={() => setModalName("")} />
        ) : (
          ""
        )}
      </div>
