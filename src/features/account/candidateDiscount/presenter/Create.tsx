import { createCandidateDiscount } from "../repository";
...
export default function Main(props: {
    onClose: any, fetchCandidateDiscountList: any,
    ...
    async function onClickAdd() {
        ...
        // call create
        const newArray={...CandidateDiscount,visaProfessionList:visaProfessionList}
        const flag = await createCandidateDiscount(newArray)
