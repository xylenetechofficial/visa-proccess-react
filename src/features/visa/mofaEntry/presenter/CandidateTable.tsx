...
const CandidateTable = (props: {
  ...
  function onUpdateRow(index: number, rowData: Mofa_Entry_Candidate_Interface) {
    const nextData: Mofa_Entry_Candidate_Interface[] = props.candidateList.map(
      (e, i) => {
        if (i === index) {
  ...
  const tableHeadings_for_non_ksa_Component = tableHeadings_for_non_ksa.map(
    (e) => <TableHeadCell3> {e[0]}</TableHeadCell3>
  );
  ...
  const tableHeadings_for_ksa_Component_for_1 = tableHeadings_for_ksa.map(
    (e) => <TableHeadCell3> {e[0]}</TableHeadCell3>
  );
  return (
    <div className="overflow-auto" style={{ justifyContent: "center" }}>
      <Table3>
        <TableHead3>
          <TableHeadRow3>
            {countryTypeID == 1
              ? tableHeadings_for_ksa_Component_for_1
              : tableHeadings_for_non_ksa_Component}
          </TableHeadRow3>
        </TableHead3>
        <TableBody3>
        ...
        <>
          ...
          <TableCell3>
            <DateInput
              ...
              onChange={(value) =>
                setLocalRowData({ ...localRowData, visa_issue_date: value })
              }
            />
          </TableCell3>
