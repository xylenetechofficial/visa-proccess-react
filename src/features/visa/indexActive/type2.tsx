export interface ActiveIndexListInterface {
    "id": number,
    "job_order_no": string,
    "index_date": string,
    "company_name": string,
...
export interface ActiveIndexListAdapter {
    "id": number,
    "job_order_no": string,
    "index_date": string,
    "company_name": string,
...
export class ActiveIndexListConverter {
    // private i: ActiveIndexListInterface
    // private a: ActiveIndexListAdapter

    /**
     * toInterface
     */
    public static toInterface(a: ActiveIndexListAdapter) {
        const data: ActiveIndexListInterface = {
            "id": a.id,
     ...
     * toAdapter
     */
    public static toAdapter(i: ActiveIndexListInterface) {
        console.log("i"); // Only Dev
        console.log(i); // Only Dev
        const data: ActiveIndexListAdapter = {
            "id": i.id,
