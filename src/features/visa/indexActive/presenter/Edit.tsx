      ...
      >
        <div className=" grid grid-cols-1 py-3  gap-2 shadow">
          ...
          <UpdateContentBox>
            ...
            <DateInput
              id="date"
              value={props.editindexActiveList.visa_date_arabic}
              onChange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexActiveList.visa_number}
              onchange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  visa_number: value,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              type="number"
              value={props.editindexActiveList.visa_fee}
              onchange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
          ...
          <UpdateContentBox>
            ...
            <DateInput
              value={props.editindexActiveList.visa_issue_date}
              onChange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  visa_issue_date: value,
                })
              }
              id={""}
            />
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexActiveList.visa_submission}
              onchange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  visa_submission: value,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexActiveList.aravic_sponsor_name}
              onchange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  aravic_sponsor_name: value,
                })
              }
            />
            {/* name Input */}
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexActiveList.sponsor_id}
              onchange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  sponsor_id: value,
          ...
          <UpdateContentBox>
            ...
            <DateInput
              value={props.editindexActiveList.visa_expiry_date}
              onChange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexActiveList.division}
              onchange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  division: value,
          ...
          <UpdateContentBox>
            ...
            <CustomRadioButton
              ...
              onChange={(value) =>
                props.setEditIndexActiveList({
                  ...props.editindexActiveList,
                  visa_accountable: parseInt(value),
                })
              }
              option={[
                { name: "Yes", value: 1 },
