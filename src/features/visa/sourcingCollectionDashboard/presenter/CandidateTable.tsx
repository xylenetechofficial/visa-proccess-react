...
const CandidateTable = (props: {
  ...
  function onUpdateRow(
    index: number,
    rowData: Src_Col_Dash_CandidateInterface
  ) {
    const nextData: Src_Col_Dash_CandidateInterface[] = props.candidateList.map(
      (e, i) => {
        if (i === index) {
...
const TableData = (props: {
  ...
  const [localRowData, setLocalRowData] =
    useState<Src_Col_Dash_CandidateInterface>(initValue);
  useEffect(() => {
  ...
  return (
    <TableRow3 key={props.index}>
      ...
      <TableCell3>{props.data.candidateCode}</TableCell3>
      ...
      <TableCell3>{props.data.agent_name}</TableCell3>{" "}
      <TableCell3>{props.data.age}</TableCell3>{" "}
      <TableCell3>{props.data.InterviewSector}</TableCell3>{" "}
      <TableCell3>{props.data.contactNo}</TableCell3>
      <TableCell3>
        <CustomSingleCheckBox
          onChange={(value) =>
      ...
      <TableCell3>
        <CustomSelectComponentUnlabeled
          onChange={(value) =>
            setLocalRowData({ ...localRowData, medicalStatus: value })
          }
          options={[
            { name: "Fit", value: "Fit" },
      ...
      <TableCell3>
        <CustomSingleCheckBox
          onChange={(value) =>
            setLocalRowData({ ...localRowData, pp: value ? 1 : 0 })
          }
      ...
      <TableCell3>
        <CustomSingleCheckBox
          onChange={(value) =>
            setLocalRowData({ ...localRowData, photo: value ? 1 : 0 })
          }
      ...
      <TableCell3>
        <CustomSingleCheckBox
          onChange={(value) =>
            setLocalRowData({ ...localRowData, medical: value ? 1 : 0 })
          }
          value={localRowData.medical ? true : false}
        />
      </TableCell3>
      <TableCell3>{props.data.status}</TableCell3>
      <TableCell3>
        <CustomSingleCheckBox
          onChange={(value) =>
            setLocalRowData({
              ...localRowData,
              docsForwardedToRc: value ? 1 : 0,
            })
          }
