...
const DubaiDataEntryTable = (props: {
  ...
  const onClickAdd = async (element: DubaiDataEntryInterface) => {
   await updateDubaiDataEntryOne(element);
    setCurrentData({
      ...currentData,
      documentCharges: element.documentCharges,
    });
  ...
  return (
    <div className="overflow-auto" style={{ justifyContent: "center" }}>
      <Table3>
        ...
        <TableBody3>
          {props.dubaiDataEntryList &&
            props.dubaiDataEntryList.map((ele, index) => (
              <TableData
                snoBase={index}
                data={ele}
                index={index}
    ...
    <TableRow3 key={props.index}>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({ ...localRowData, candidateName: value })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({ ...localRowData, passportNo: value })
          }
        />
      </TableCell3>
      <TableCell3>
        <DateInput
          ...
          onChange={(value) =>
            setLocalRowData({ ...localRowData, ppIssueDate: value })
          }
        />
      </TableCell3>
      <TableCell3>
        <DateInput
          ...
          onChange={(value) =>
            setLocalRowData({ ...localRowData, ppExpiryDate: value })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({ ...localRowData, placeOfIssue: value })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <DateInput
          ...
          onChange={(value) =>
            setLocalRowData({ ...localRowData, dateOfBirth: value })
          }
        />
      </TableCell3>
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({ ...localRowData, placeOfBirth: value })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({ ...localRowData, nomineeName: value })
          }
        />
      </TableCell3>
      <TableCell3>
        <CustomSelectComponentUnlabeled
          ...
          onChange={(value) =>
            setLocalRowData({ ...localRowData, nomineeRelation: value })
          }
        />
      </TableCell3>
      <TableCell3>
      ...
      <TableCell3>{localRowData.actualProfession}</TableCell3>
      <TableCell3>
        <UnlabeledInput
          value={localRowData.visaProfession}
          onchange={(value) =>
            setLocalRowData({ ...localRowData, visaProfession: value })
          }
        />
      </TableCell3>
      ...
      <TableCell3>{convertDateFormat(localRowData.molDate)}</TableCell3>

      <TableCell3>{convertDateFormat(localRowData.workPermitDate)}</TableCell3>
      ...
      <TableCell3>
        <CustomSelectComponentUnlabeled
          ...
          onChange={(value) =>
            setLocalRowData({ ...localRowData, ppCopy: value })
          }
        />
      </TableCell3>
      <TableCell3>
        <CustomSingleCheckBox
          ...
          onChange={(value) => {
            ...
            if (value) {
              setLocalRowData({
                ...localRowData,
                ppReceived: value ? 1 : 0,
                ppReceivedDate: `${year}-${month}-${day}`,
              });
            } else {
              setLocalRowData({
                ...localRowData,
      ...
      <TableCell3>
        <DateInput
          ...
          onChange={(value) =>
            setLocalRowData({ ...localRowData, ppReceivedDate: value })
          }
        />
      </TableCell3>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <UnlabeledInput
            ...
            onchange={(value) =>
              setLocalRowData({
                ...localRowData,
                documentCharges: parseInt(value),
              })
            }
          />
          <div>
