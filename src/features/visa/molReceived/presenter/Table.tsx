            ...
            <TableRow3 key={index}>
                  ...
                  onChange={(value) => {
                    ...
                    if (value)
                      onUpdateRow(index, {
                        ...ele,
                        checked: 1,
                        molReceievedStatus: "yes",
                        molReceiedDate: `${getJsDate()}`,
                      });
                    else
                      onUpdateRow(index, {
                        ...ele,
              ...
              <TableCell3>
                <CustomSelectComponentUnlabeled
                  ...
                  options={[
                    { name: "yes", value: "yes" },
                    { name: "Ammendment", value: "Ammendment" },
                  ]}
                  value={ele.molReceievedStatus}
                />
              </TableCell3>
              <TableCell3>
                {" "}
                {ele.molReceiedDate
                  ? convertDateFormat(ele.molReceiedDate)
                  : ""}
              </TableCell3>
              ...
              <TableCell3>
                <UnlabeledInput
                  onchange={(value) => {
                    onUpdateRow(index, { ...ele, molNumber: value });
                  }}
                  value={ele.molNumber}
                />
              </TableCell3>
