      ...
      >
        <div className=" grid grid-cols-1 py-3  gap-2 shadow">
          ...
          <UpdateContentBox>
            ...
            <DateInput
              id="date"
              value={props.editindexFullList.visa_date_arabic}
              onChange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexFullList.visa_number}
              onchange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
                  visa_number: value,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              type="number"
              value={props.editindexFullList.visa_fee}
              onchange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
          ...
          <UpdateContentBox>
            ...
            <DateInput
              value={props.editindexFullList.visa_issue_date}
              onChange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexFullList.visa_submission}
              onchange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
                  visa_submission: value,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexFullList.aravic_sponsor_name}
              onchange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexFullList.sponsor_id}
              onchange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
                  sponsor_id: value,
          ...
          <UpdateContentBox>
            ...
            <DateInput
              value={props.editindexFullList.visa_expiry_date}
              onChange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
          ...
          <UpdateContentBox>
            ...
            <UnlabeledInput
              value={props.editindexFullList.division}
              onchange={(value) =>
                props.setEditIndexFullList({
                  ...props.editindexFullList,
                  division: value,
