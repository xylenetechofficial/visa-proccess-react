                    ...
                    {props.jobOrderList.map((ele, index) => (
                        ...
                        <TableRow3 key={index}>
                           <TableCell3 >{index + props.snoBase+1}</TableCell3>
                            ...
                            <TableCell3 > {convertDateFormat(ele.submitedDate)}</TableCell3>
                            <TableCell3 >
                            ...
                            <TableCell3>
                                <CustomSelectComponentUnlabeled
                                    ...
                                    onChange={(value) => {
                                        ...
                                        const year = date.getFullYear();
                                        if (value == "yes")
                                            onUpdateRow(index, { ...ele, workPermitReceived: "yes", workPermitReceivedDate: `${year}-${month}-${day}` })
                                        else {
                                            onUpdateRow(index, { ...ele, workPermitReceived: value, workPermitReceivedDate: `` })

                                        }

                                    }}
                                    value={ele.workPermitReceived ? true : false}
                                />
                            </TableCell3>
                            <TableCell3 > {ele.workPermitReceivedDate ? convertDateFormat(ele.submitedDate) : ""}</TableCell3>
