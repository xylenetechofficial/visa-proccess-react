...
export interface MolReceivedInterface {
  ...
  workPermitReceived:string,
  workPermitReceivedDate:string,
}
...
export interface MolReceivedAdapter {
  ...
  // mol_number:string,
  submitted_to_company:string,
  submitted_to_company_date:string,

  work_permit_received:string,
...
export class MolReceivedConverter {
  ...
  public static toInterface(a: MolReceivedAdapter) {
    const data: MolReceivedInterface = {
      ...
      submitedDate:a.submitted_to_company_date,
      submittedToCompany:a.submitted_to_company,

      workPermitReceived:a.work_permit_received,
      workPermitReceivedDate:a.work_permit_received_date
  ...
  public static toAdapter(i: MolReceivedInterface) {
    const data: MolReceivedAdapter = {
      ...
      submitted_to_company:i.submittedToCompany,
      submitted_to_company_date:i.submitedDate,
      work_permit_received:i.workPermitReceived,
      work_permit_received_date:i.workPermitReceivedDate
