...
export default function Main() {
  ...
  const [editInterviewSector, setEditInterviewSector] =
    useState<InterviewSectorInterface>({} as InterviewSectorInterface);
    ...
    <div>
      ...
      {modalName !== "create" ? (
        ...
        <CreateModal
          ...
          fetchInterviewSectorList={fetchInterviewSectorList}
        />
      )}
      ...
      {modalName !== "edit" ? (
        ...
        <EditModal
          interviewSector={editInterviewSector}
          onClose={() => setModalName("")}
          fetchInterviewSectorList={fetchInterviewSectorList}
        />
      )}
