...
export interface JobOrderActualProfessionList {
  id?: number;
  name: string;
}
...
export interface SelectionJobOrderInterface {
  job_order_actual_profession_list: JobOrderActualProfessionList[];
  job_order_sector_list: JobOrderSectorList[];
  job_order_no: string;
  job_order_id: any;
}

export interface SelectionJobOrderAdapter {
  job_order_actual_profession_list: JobOrderActualProfessionList[];
  job_order_sector_list: JobOrderSectorList[];
  job_order_no: string;
  job_order_id: number;
...
export class SelectionJobOrderConverter {
  // private i: SelectionJobOrderInterface
  // private i: SelectionJobOrderAdapter

  /**
   * toInterface
   */
  public static toInterface(i: SelectionJobOrderAdapter) {
    const data: SelectionJobOrderInterface = {
   ...
   * to interface list
   */
  public static toInterfaceList(i_list: SelectionJobOrderAdapter[]) {
    const data_list: SelectionJobOrderInterface[] = [];
   ...
   * toAdapter
   */
  public static toAdapter(i: SelectionJobOrderInterface) {
    const data: SelectionJobOrderAdapter = {
      job_order_actual_profession_list: i.job_order_actual_profession_list,
      job_order_sector_list: i.job_order_sector_list,
      job_order_no: i.job_order_no,
      job_order_id: i.job_order_id,
   ...
   * toAdapter list
   */
  public static toAdapterList(i_list: SelectionJobOrderInterface[]) {
    const data_list: SelectionJobOrderAdapter[] = [];
