import { JobOrderActualProfessionList, JobOrderSectorList, SelectionInterface, SelectionJobOrderInterface } from '../type'
...
const SelectionTable = (props: {
    ...
    company: number,
    joborder: SelectionJobOrderInterface,
    ...
    const initValue: SelectionInterface = {
        ...
        ha: 0,
        ha_or_ta_provided: 0,
        job_order_id: props.joborder.job_order_id,
        name: "",
        nominee_name: "",
        nominee_relation: "",
        other_allowance: 0,
    ...
    const [sectorList, setSectorList] = useState<JobOrderSectorList[]>([])
    const [actualProfessionList, setActualProfessionList] = useState<JobOrderActualProfessionList[]>([])
    ...
    useEffect(() => {
        console.log("==========     Selection Table3   ==========");   // Only Dev
        console.log(props.joborder);   // Only Dev
    }, [props.joborder])
    ...
    useEffect(() => {
        fetchAgentList()
        // fetchSectorList()
        // setSectorList(props.joborder.job_order_sector_list)
        // setActualProfessionList(props.joborder.job_order_actual_profession_list)
                ...
                <TableBody3>
                    {props.selectionList && props.selectionList.map((ele, index) => (
                        <TableData
                            ...
                            agentList={agentList}
                            jobOrderSectorList={props.joborder.job_order_sector_list}
                            jobOrderActualProfessionList={props.joborder.job_order_actual_profession_list}
...
const TableData = (
    props: {
        ...
        jobOrderSectorList: JobOrderSectorList[],
        jobOrderActualProfessionList: JobOrderActualProfessionList[],
    ...
    useEffect(() => {
        ...
        console.log("==========     Data Table3   ==========");   // Only Dev
        console.log(props.jobOrderActualProfessionList);   // Only Dev
        console.log(props.jobOrderSectorList);   // Only Dev
    }, [localRowData])
        ...
        <TableRow3 key={props.index}>
            ...
            <TableCell3 >
                ...
                <CustomSelectComponentUnlabeled
                    value={localRowData.actual_profession}
                    onChange={(value: any) => setLocalRowData({ ...localRowData, actual_profession: value })}
                    options={selectOptionConveter({ options: props.jobOrderActualProfessionList, options_struct: { name: "name", value: "name" } })}
                />
            </TableCell3>
            <TableCell3 >
                {/* total salary*/}
            ...
            <TableCell3 >
                <CustomSelectComponentUnlabeled
                    ...
                    options={selectOptionConveter({ options: props.jobOrderSectorList, options_struct: { name: "name", value: "id" } })}
                />
            </TableCell3>
