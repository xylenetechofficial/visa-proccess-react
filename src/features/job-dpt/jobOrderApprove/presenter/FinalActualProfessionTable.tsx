  ...
  return (
    <div className="overflow-auto" style={{ justifyContent: "center" }}>
      <Table3>
        ...
        <TableBody3>
          {props.actualProfessionList &&
            props.actualProfessionList.map((ele, index) => (
              <TableData
                data={ele}
                index={index}
                onChange={onChange}
    ...
    <TableRow3 key={props.index}>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          type="number"
          onchange={(value) =>
            setLocalRowData({ ...localRowData, quantity: parseInt(value) })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({
              ...localRowData,
              service_charges: parseInt(value),
            })
          }
        />
      </TableCell3>
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({
              ...localRowData,
              partial_charges: parseInt(value),
            })
          }
        />
      </TableCell3>
      <TableCell3>
        <UnlabeledInput
          ...
          type="number"
          onchange={(value) =>
            setLocalRowData({ ...localRowData, sector_charge: parseInt(value) })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({
              ...localRowData,
              agent_commission: parseInt(value),
            })
          }
        />
      </TableCell3>
      <TableCell3>
        ...
        <CustomRadioButton
          ...
          value={localRowData.air_ticket}
          onChange={(value) =>
            setLocalRowData({ ...localRowData, air_ticket: value })
          }
        />
      </TableCell3>
      <TableCell3>
      ...
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({
              ...localRowData,
              invoice_service_charges: parseInt(value),
            })
          }
        />
      </TableCell3>
      <TableCell3>
        <UnlabeledInput
          ...
          onchange={(value) =>
            setLocalRowData({
              ...localRowData,
              invoice_ticket_charges: parseInt(value),
            })
          }
        />
      </TableCell3>
      ...
      <TableCell3>
        <CustomSelectComponentUnlabeled
          ...
          onChange={(value: any) =>
            setLocalRowData({
              ...localRowData,
              invoice_service_charges_currency: parseInt(value),
            })
          }
