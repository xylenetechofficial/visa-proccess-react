...
export const AirTicketList = [
  { name: "PROVIDED. BY CO.", value: "PROVIDED. BY CO." },
  { name: "BY AGENCY", value: "BY AGENCY" },
  { name: "RAISE INVOICE", value: "RAISE INVOICE" },
];

export const SelectionStatusList = [
  { name: "Selected", value: "Selected" },
  { name: "Stand By", value: "Stand By" },
];

export const NomineeRelationList = [
...
export const CopyPPList = [
  { name: "PP", value: "PP" },
  { name: "COPY", value: "COPY" },
];

export const VisaSubmissionList = [
