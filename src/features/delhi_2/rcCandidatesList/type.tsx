...
export interface RC_CandidateInterface {
...
export interface RC_CandidateAdapter {
  id?: number,
  name: string
  passport_no: string
  company_name: string
...
export class RC_CandidateConverter {
  // private i: RC_CandidateInterface
  // private a: RC_CandidateAdapter

  /**
   * toInterface
   */
  public static toInterface(a: RC_CandidateAdapter) {
    const data: RC_CandidateInterface = {
      id: a.id,
      name: a.name,
  ...
  public static toInterfaceList(a_list: RC_CandidateAdapter[]) {
    const data_list: RC_CandidateInterface[] = [];
   ...
   * toAdapter
   */
  public static toAdapter(i: RC_CandidateInterface) {
    console.log("i"); // Only Dev
    console.log(i); // Only Dev
    const data: RC_CandidateAdapter = {
      id: i.id,
      name: i.name,
  ...
  public static toAdapterList(i_list: RC_CandidateInterface[]) {
    const data_list: RC_CandidateAdapter[] = [];
